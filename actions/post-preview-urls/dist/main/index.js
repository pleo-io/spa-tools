...
// post-preview-urls/index.ts
var post_preview_urls_exports = {};
__export(post_preview_urls_exports, {
  postPreviewUrls: () => postPreviewUrls
});
module.exports = __toCommonJS(post_preview_urls_exports);
...
runAction(async () => {
  ...
  const prNumber = (_a = github.context.payload.pull_request) == null ? void 0 : _a.number;
...
async function getPRDescription(octokit, prNumber, repo) {
