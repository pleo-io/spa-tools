...
var cursor_deploy_exports = {};
__export(cursor_deploy_exports, {
  branchNameToHostnameLabel: () => branchNameToHostnameLabel,
  cursorDeploy: () => cursorDeploy
});
module.exports = __toCommonJS(cursor_deploy_exports);
...
async function execReadOutput(commandLine, args) {
  let output = "";
...
// cursor-deploy/index.ts
var deployModes = ["default", "rollback", "unblock"];
runAction(async () => {
  var _a, _b;
  ...
  const output = await cursorDeploy({
    ...
    deployModeInput,
    rollbackCommitHash,
    ref: ((_b = (_a = github.context.payload) == null ? void 0 : _a.pull_request) == null ? void 0 : _b.head.ref) ?? github.context.ref
  });
